...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "", "", "", "OFFICE", "BLENDER", "PICTURE", ""}
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "F2", function ()
        ...
        {description = "Firefox Web Browser", group = "applications"}),
    
        -- Emacs
    awful.key({ modkey }, "F4", function ()
        awful.util.spawn("emacs") end,
        {description = "Emacs Distro", group = "applications"}),
    ...
    awful.key({ modkey }, "F3", function ()
        ...
        {description = "Dolphin File Manager", group = "applications"}),
...
awful.spawn.with_shell("manjaro-hello")
